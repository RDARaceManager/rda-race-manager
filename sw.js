const CACHE='rda-v463-banner-mobile';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./assets/rda-mark.png','./assets/calendario-settembre-2026.jpg','./assets/rda-home-hero-v460.png'];
